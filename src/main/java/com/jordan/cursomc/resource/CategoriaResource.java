...
import com.jordan.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insertEntity(@RequestBody Categoria obj) {
	...
	public ResponseEntity<Void> updateEntity(@RequestBody Categoria obj, @PathVariable Integer id) {
